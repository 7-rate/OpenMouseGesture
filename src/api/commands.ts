...
export async function updateAction(gesture: string, action: Action): Promise<void> {
  return invoke("update_action", { gesture, action });
}

export async function deleteAction(gesture: string): Promise<void> {
  return invoke("delete_action", { gesture });
}
